...
uses
  ...
  Dialogs, ExtCtrls, StdCtrls, Menus, ComCtrls, ScktComp, StreamManager,
  AppEvnts, MMSystem;
...
procedure TForm1.SS1ClientError(Sender: TObject; Socket: TCustomWinSocket; ErrorEvent: TErrorEvent; var ErrorCode: Integer);
begin
  ErrorCode := 0;
...
begin
  Application.MessageBox('Criado por Maickonn Richard. Contato: maickonnrichard@hotmail.com  ou   senjaxus@gmail.com', 'About', 64);
end;
...
begin
  ...
  if LV1.Selected.SubItems.Objects[4] = nil then
  begin
